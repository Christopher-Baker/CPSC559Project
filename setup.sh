...
# This script assumes the code is complied already you can do this by running `make all`
...
cd src && java CPSC559.LoadBalancerMain &

# to start a client open another terminal and run `cd src && java CPSC559.Client`
